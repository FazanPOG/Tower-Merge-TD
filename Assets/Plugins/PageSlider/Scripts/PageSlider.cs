...
namespace TS.PageSlider
{
    ...
    public class PageSlider : MonoBehaviour
    {
        ...
        public GameObject AddPage(RectTransform content)
        {
            if (_scroller == null)
            {
                _scroller = FindScroller();
            ...
            var group = content.AddComponent<GridLayoutGroup>();
            group.cellSize = new Vector2(200, 200);
            group.spacing = new Vector2(40, 30);
            group.startCorner = GridLayoutGroup.Corner.UpperLeft;
            group.startAxis = GridLayoutGroup.Axis.Horizontal;
            group.childAlignment = TextAnchor.MiddleCenter;
            group.constraint = GridLayoutGroup.Constraint.FixedColumnCount;
            group.constraintCount = 7;
            var contentSizeFilter = content.AddComponent<ContentSizeFitter>();
