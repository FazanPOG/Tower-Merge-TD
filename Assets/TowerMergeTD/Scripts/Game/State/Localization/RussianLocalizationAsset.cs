    ...
    public class RussianLocalizationAsset : ILocalizationAsset
    {
        ...
        public RussianLocalizationAsset()
        {
            _translationMap = new Dictionary<string, string>()
            {
                ...
                [LocalizationKeys.LEVEL_1_TUTORIAL_TEXT_1_KEY] = "Вы можете ставить башни только на специальные участки с квадратной обводкой. Нажмите на левый из них, чтобы построить свою первую башню!",
                ...
                [LocalizationKeys.LEVEL_1_TUTORIAL_TEXT_6_KEY] = "Теперь нажмите на правый, чтобы поставить вторую башню",
                [LocalizationKeys.LEVEL_1_TUTORIAL_TEXT_7_KEY] = "Поставьте вторую башню",
                [LocalizationKeys.LEVEL_1_TUTORIAL_TEXT_8_KEY] = "Вы можете перемещать башни на другие участки. Если две одинаковые башни объединить, получится более мощная версия, попробуйте!",
