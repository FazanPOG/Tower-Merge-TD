...
{
    public class YandexGamesGameStateProvider : IGameStateProvider
    {
        ...
        public YandexGamesGameStateProvider(ProjectConfig projectConfig, MonoBehaviourWrapper monoBehaviourWrapper)
        {
